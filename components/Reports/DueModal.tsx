...
import { setDueModalVisible, setFeesModalVisible } from "@/redux/reducer/reportSlice";
...
const DueModal = () => {
  ...
  const { dueModalVisible } = useSelector(
    ...
    <>
      ...
      >
        ...
        >
          <TouchableOpacity
            activeOpacity={1}
            onPress={() => dispatch(setDueModalVisible())}
            style={{
              position: "absolute",
              height: "100%",
              width: "100%",
